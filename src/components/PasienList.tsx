...
const PasienList: React.FC<PasienListProps> = ({ pasienData, onSelect, selectedIndex, isOpen, onClose, onDelete }) => {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg p-6 shadow-lg max-w-lg w-full max-h-[70vh] overflow-y-auto">
        <div className="flex justify-between mb-5">
          <h2 className="font-semibold text-lg">Data Pasien</h2>
          <button className="text-sm border-1 border-gray-300 p-2 rounded cursor-pointer hover:bg-gray-100" onClick={onClose}>X</button>
        </div>
